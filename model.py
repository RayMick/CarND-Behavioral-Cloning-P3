...
# Read in the training data from driving clock wise (reverse of counter-clock wise)
    ...
    while 1: # Loop forever so the generator never terminates
        ...
        for offset in range(0, num_samples, batch_size):
            ...
            for batch_sample in batch_samples:
                ...
                # If the file is not in dataset dir1, it should be in the dataset dir2
                if os.path.isfile(name):
                    pass
                else:
                    name = '../../../recordings_reverse_track_try2/IMG/' + filename
